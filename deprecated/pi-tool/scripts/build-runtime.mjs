...
const FORBIDDEN_EAGER_INPUTS = ["src/tool-catalog.ts"];
...
export async function buildRuntime({
	...
	const stagingDirectory = await mkdtemp(join(dirname(resolvedOutputDirectory), ".pi-tool-dist-"));
...
async function assertSafeOutputDirectory(outputDirectory) {
	...
	const isTestOutput = firstSegment?.startsWith(".pi-tool-build-test-");
	if (
		relativeOutput === "" ||
		relativeOutput === ".." ||
