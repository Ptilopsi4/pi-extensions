...
const FORBIDDEN_EAGER_INPUTS = ["src/browser-settings-menu.ts", "src/menu.ts"];
...
export async function buildRuntime({
	...
	const stagingDirectory = await mkdtemp(
		join(dirname(resolvedOutputDirectory), ".pi-chrome-devtools-dist-"),
	);
...
async function assertSafeOutputDirectory(outputDirectory) {
	...
	const isTestOutput = firstSegment?.startsWith(".pi-chrome-devtools-build-test-");
	if (
		relativeOutput === "" ||
		relativeOutput === ".." ||
