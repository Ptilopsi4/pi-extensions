...
const FORBIDDEN_EAGER_INPUTS = ["src/settings-menu.ts"];
...
export async function buildRuntime({
	...
	const stagingDirectory = await mkdtemp(
		join(dirname(resolvedOutputDirectory), ".pi-codex-compact-dist-"),
	);
...
async function assertSafeOutputDirectory(outputDirectory) {
	...
	const isTestOutput = firstSegment?.startsWith(".pi-codex-compact-build-test-");
	if (
		relativeOutput === "" ||
		relativeOutput === ".." ||
