...
const FORBIDDEN_EAGER_INPUTS = ["src/runtime.ts"];
...
export async function buildRuntime({
	...
	const stagingDirectory = await mkdtemp(
		join(dirname(resolvedOutputDirectory), ".pi-langfuse-dist-"),
	);
...
async function assertSafeOutputDirectory(outputDirectory) {
	...
	const isTestOutput = firstSegment?.startsWith(".pi-langfuse-build-test-");
	if (
		relativeOutput === "" ||
		relativeOutput === ".." ||
