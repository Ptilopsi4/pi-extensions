...
const FORBIDDEN_EAGER_INPUTS = ["src/menu.ts", "src/picker.ts"];
...
export async function buildRuntime({
	...
	const stagingDirectory = await mkdtemp(
		join(dirname(resolvedOutputDirectory), ".pi-recall-dist-"),
	);
...
async function assertSafeOutputDirectory(outputDirectory) {
	...
	const isTestOutput = firstSegment?.startsWith(".pi-recall-build-test-");
	if (
		relativeOutput === "" ||
		relativeOutput === ".." ||
