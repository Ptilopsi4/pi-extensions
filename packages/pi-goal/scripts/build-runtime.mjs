...
const FORBIDDEN_EAGER_INPUTS = ["src/menu.ts", "src/settings-ui.ts"];
...
export async function buildRuntime({
	...
	const stagingDirectory = await mkdtemp(join(dirname(resolvedOutputDirectory), ".pi-goal-dist-"));
...
async function assertSafeOutputDirectory(outputDirectory) {
	...
	const isTestOutput = firstSegment?.startsWith(".pi-goal-build-test-");
	if (
		relativeOutput === "" ||
		relativeOutput === ".." ||
